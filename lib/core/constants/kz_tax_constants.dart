...
class KzTax {
  ...
  /// Социальный налог за работника (для формы 200, ТОО/ИП на ОУР).
  /// Классическая формула: (ЗП − ОПВ) × ставка − СО, не ниже 0.
  /// ⚠ Реформа НК 2026 уточняет ставку — вынесено в конфиг для правки
  /// без передеплоя. Значение по умолчанию = 9.5% (исторический СН).
  static double get employeeSocialTaxRate => _cfg('ee_social_tax_rate', 0.095);

  // ═══════════════════════════════════════════════════════════════════════════
  // РЕЖИМ САМОЗАНЯТЫХ
  // (Заменил режимы патента и ЕСП, отменённые с 01.01.2026 — Закон 214-VIII)
  // ═══════════════════════════════════════════════════════════════════════════
...
/// ЕСП и патент отменены с 01.01.2026 (Закон 214-VIII) — их заменил
/// режим самозанятых.
enum TaxRegime {
