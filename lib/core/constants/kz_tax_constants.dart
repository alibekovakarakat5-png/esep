...
class KzTax {
  ...
  /// Социальный налог за работника (форма 200, ТОО/ИП на ОУР).
  /// НК-2026: 6% от (ЗП − ОПВ − ВОСМС), БЕЗ взаимозачёта СО, мин. база 14 МРП.
  /// (Было: 9.5% − СО — взаимозачёт отменён с 2026.) В конфиге — правка без передеплоя.
  static double get employeeSocialTaxRate => _cfg('ee_social_tax_rate', 0.06);
