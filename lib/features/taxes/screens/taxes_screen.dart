        ...
        child: const Padding(
          ...
          child: Row(
            children: [
              ...
              Expanded(
                child: Text(
                  'Ставки 2026: упрощёнка 4% (маслихат может менять до 2-6%), соцстрахование 5%, пенсия работодателя 3.5%, медстрахование 5%. Самозанятые — 4%.',
...
class _GeneralCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final sn = KzTax.ipMonthlySocialTax() * 12; // СН ИП на ОУР за год
    return Card(
      child: Padding(
        padding: const EdgeInsets.all(16),
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          const SizedBox(height: 8),
          _TaxRow('Соцналог (2 МРП/мес)', fmt.format(sn), EsepColors.expense),
          const Divider(height: 20),
          const Text(
